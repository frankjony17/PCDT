...
Ext.define('CDT.view.control_calidad.especialista.Viewport', {
    extend: 'Ext.container.Viewport',
    xtype: 'viewport-control-calidad',
    ...
    initComponent: function()
    {
        ...
        me.items = [{
            ...
            items:[{
                xtype: 'buttongroup',
                items: [{
                    text: 'Tipo de controles',
                    tooltip: 'Tipo de controles.',
                    xtype: 'button',
                    iconCls: 'fa fa-wrench',
                    id: 'tipo-control-button-id'
                },{
                    text: 'Controles',
                    tooltip: 'Controles realizados.',
                    xtype: 'button',
                    iconCls: 'fa fa-cogs',
