...
Ext.define('CDT.view.tarea_operativa.especialista.ChartPanel', {
    ...
    {
        var me = this,
            chartpie = Ext.create('CDT.view.tarea_operativa.especialista.chart.PieChart'),
            chartbar = Ext.create('CDT.view.tarea_operativa.especialista.chart.BarChart');
        ...
        me.items = [{
            ...
            items: [{
                title: 'Total de tareas por departamento. (Año en curso)',
                flex: 4,
                margin: '0 10 0 0',
                items: [{
                    xtype: 'toolbar',
