...
Ext.define('CDT.controller.admin.SeguridadTreeController', {
    extend: 'Ext.app.Controller',

    views: [
        'admin.SeguridadTreePanel'
    ],
   ...
   //Identificar nodo seleccionado... 
    ...
    {   
        ...
        switch (iconCls) {
            case 'tree-roles':
                item = Ext.create('CDT.view.admin.roles.RolesGrid');
                break;
            case 'tree-usuarios':
                item = Ext.create('CDT.view.admin.users.UsersGrid');
                break;
        }
        return item;
    },    
