 ...
 */
class Departamento extends \Otros\NomencladorBundle\Entity\Departamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Otros\\NomencladorBundle\\Entity\\Departamento' . "\0" . 'id', '' . "\0" . 'Otros\\NomencladorBundle\\Entity\\Departamento' . "\0" . 'codigo', '' . "\0" . 'Otros\\NomencladorBundle\\Entity\\Departamento' . "\0" . 'nombre', '' . "\0" . 'Otros\\NomencladorBundle\\Entity\\Departamento' . "\0" . 'telefonos');
        }
