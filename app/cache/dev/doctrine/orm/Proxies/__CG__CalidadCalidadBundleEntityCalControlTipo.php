 ...
 */
class CalControlTipo extends \Calidad\CalidadBundle\Entity\CalControlTipo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Calidad\\CalidadBundle\\Entity\\CalControlTipo' . "\0" . 'id', '' . "\0" . 'Calidad\\CalidadBundle\\Entity\\CalControlTipo' . "\0" . 'nombre', '' . "\0" . 'Calidad\\CalidadBundle\\Entity\\CalControlTipo' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CalControlTipo $proxy) {
